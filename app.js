...
function printSticker() {
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0; font-family:Arial,sans-serif; }
    ...
    .sticker-page {
      width:100mm; height:90mm; padding:4mm;
      display:flex; flex-direction:column; justify-content:space-between;
      overflow:hidden;
    }
    .despacho-label { font-size:6pt; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:1px; margin-bottom:1mm; }
    .factura-num { font-size:15pt; font-weight:900; color:#1a2744; line-height:1; }
    .sep { border:none; border-top:0.4mm solid #1a2744; margin:2mm 0; }
    .row { display:flex; justify-content:space-between; align-items:baseline; margin-bottom:1mm; }
    .lbl { font-size:5.5pt; color:#94a3b8; text-transform:uppercase; font-weight:600; letter-spacing:0.3px; flex-shrink:0; }
    .val { font-size:7.5pt; font-weight:700; color:#1a2744; text-align:right; max-width:58mm; word-break:break-word; }
    .dir-val { font-size:7pt; font-weight:700; color:#1a2744; line-height:1.25; }
    .bottom { border-top:0.4mm solid #e2e8f0; padding-top:1.5mm; display:flex; flex-direction:column; align-items:center; }
    .caja-counter { display:flex; align-items:baseline; gap:1mm; line-height:1; }
    .caja-actual { font-size:18pt; font-weight:900; color:#1a2744; }
    .caja-sep    { font-size:12pt; font-weight:700; color:#94a3b8; }
    .caja-total  { font-size:12pt; font-weight:700; color:#64748b; }
    .caja-label  { font-size:6.5pt; font-weight:700; color:#1a2744; text-transform:uppercase; letter-spacing:0.5px; margin-top:0.8mm; }
    .ts { font-size:5pt; color:#94a3b8; margin-top:1mm; }
  </style></head>
