...
function printSticker() {
  ...
  <style>
    ...
    * { box-sizing: border-box; font-family: Arial, sans-serif; }
    ...
    /* REMITENTE */
    .rem      { display:flex; align-items:center; gap:2mm; flex-shrink:0; }
    .logo     { width:12mm; height:12mm; object-fit:contain; flex-shrink:0; }
    .rem-info { display:flex; flex-direction:column; gap:0.4mm; }
    .rem-nom  { font-size:7pt; font-weight:900; color:#1a2744; }
    .rem-d    { font-size:5pt; color:#475569; line-height:1.3; }

    /* SEPARADOR */
    .sep { border:none; border-top:0.4mm solid #1a2744; margin:1.5mm 0; flex-shrink:0; }

    /* DESTINATARIO */
    .dest     { flex:1; display:flex; flex-direction:column; gap:0.6mm; }
    .dest-lbl { font-size:4.5pt; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.8px; }
    .fnum     { font-size:14pt; font-weight:900; color:#1a2744; line-height:1; }
    ...
    .val      { font-size:6pt; font-weight:700; color:#1a2744; text-align:right; max-width:55mm; word-break:break-word; }
    .dir      { font-size:6.5pt; font-weight:700; color:#0f172a; line-height:1.25;
                background:#f1f5f9; padding:1mm 1.5mm; border-radius:1mm; margin-top:0.5mm; }
    ...
    .ca  { font-size:16pt; font-weight:900; color:#1a2744; }
    .cs  { font-size:10pt; font-weight:700; color:#94a3b8; }
    .ct  { font-size:10pt; font-weight:700; color:#64748b; }
