...
function printSticker() {
  ...
  <style>
    ...
    * { box-sizing: border-box; font-family: Arial, sans-serif; }
    ...
    /* REMITENTE */
    .rem      { display:flex; align-items:center; gap:3mm; flex-shrink:0; }
    .logo     { width:28mm; height:28mm; object-fit:contain; flex-shrink:0; }
    .rem-info { display:flex; flex-direction:column; gap:1mm; }
    .rem-nom  { font-size:16pt; font-weight:900; color:#1a2744; }
    .rem-d    { font-size:11pt; color:#475569; line-height:1.3; }

    /* SEPARADOR */
    .sep { border:none; border-top:0.5mm solid #1a2744; margin:2mm 0; flex-shrink:0; }

    /* DESTINATARIO */
    .dest     { flex:1; display:flex; flex-direction:column; gap:1mm; }
    .dest-lbl { font-size:9pt; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.8px; }
    .fnum     { font-size:28pt; font-weight:900; color:#1a2744; line-height:1; }
    .cli      { font-size:13pt; font-weight:700; color:#1a2744; }
    .row-d    { display:flex; justify-content:space-between; align-items:baseline; }
    .lbl      { font-size:9pt; color:#94a3b8; text-transform:uppercase; font-weight:600; flex-shrink:0; }
    .val      { font-size:11pt; font-weight:700; color:#1a2744; text-align:right; max-width:55mm; word-break:break-word; }
    .dir      { font-size:11pt; font-weight:700; color:#0f172a; line-height:1.3;
                background:#f1f5f9; padding:1.5mm 2mm; border-radius:1.5mm; margin-top:1mm; }

    /* CONTADOR CAJA */
    .bot { flex-shrink:0; display:flex; flex-direction:column; align-items:center; }
    .cnt { display:flex; align-items:baseline; gap:1mm; line-height:1; }
    .ca  { font-size:36pt; font-weight:900; color:#1a2744; }
    .cs  { font-size:22pt; font-weight:700; color:#94a3b8; }
    .ct  { font-size:22pt; font-weight:700; color:#64748b; }
    .cl  { font-size:11pt; font-weight:700; color:#1a2744; text-transform:uppercase; letter-spacing:0.5px; margin-top:0.5mm; }
    .ts  { font-size:8pt; color:#94a3b8; margin-top:0.5mm; }
  </style></head>
