...
function printSticker() {
  ...
  <style>
    ...
    * { box-sizing: border-box; font-family: Arial, sans-serif; }
    ...
    .logo     { width:17mm; height:17mm; object-fit:contain; flex-shrink:0; }
    .rem-info { display:flex; flex-direction:column; gap:0.5mm; }
    .rem-nom  { font-size:9pt; font-weight:900; color:#1a2744; }
    .rem-d    { font-size:6.5pt; color:#475569; line-height:1.3; }

    /* SEPARADOR */
    .sep { border:none; border-top:0.4mm solid #1a2744; margin:1.5mm 0; flex-shrink:0; }

    /* DESTINATARIO */
    .dest     { flex:1; display:flex; flex-direction:column; gap:0.8mm; }
    .dest-lbl { font-size:6pt; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.8px; }
    .fnum     { font-size:17pt; font-weight:900; color:#1a2744; line-height:1; }
    .cli      { font-size:8.5pt; font-weight:700; color:#1a2744; }
    .row-d    { display:flex; justify-content:space-between; align-items:baseline; }
    .lbl      { font-size:6pt; color:#94a3b8; text-transform:uppercase; font-weight:600; flex-shrink:0; }
    .val      { font-size:7.5pt; font-weight:700; color:#1a2744; text-align:right; max-width:55mm; word-break:break-word; }
    .dir      { font-size:7.5pt; font-weight:700; color:#0f172a; line-height:1.25;
    ...
    .ca  { font-size:20pt; font-weight:900; color:#1a2744; }
    .cs  { font-size:13pt; font-weight:700; color:#94a3b8; }
    .ct  { font-size:13pt; font-weight:700; color:#64748b; }
    .cl  { font-size:7pt; font-weight:700; color:#1a2744; text-transform:uppercase; letter-spacing:0.5px; margin-top:0.4mm; }
    .ts  { font-size:5.5pt; color:#94a3b8; margin-top:0.4mm; }
  </style></head>
