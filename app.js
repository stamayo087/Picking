...
function printSticker() {
  ...
  for (let caja = 1; caja <= cajas; caja++) {
    ...
    pages.push(`<div class="sp"${!esUltima ? ' style="page-break-after:always;margin-bottom:4mm"' : ''}>

      <!-- Contenido rotado -45deg -->
      <div class="inner">
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0; font-family:Arial,sans-serif; }
    ...
    /* Contenido rotado -45 grados
       La diagonal de un rectángulo 80x90 ≈ 120mm → usamos ~115mm de ancho rotado */
    .inner {
      width:115mm; height:75mm;
    ...
    .rem-info { display:flex; flex-direction:column; gap:0.2mm; }
    .rem-nom  { font-size:6.5pt; font-weight:900; color:#1a2744; }
    .rem-d    { font-size:4.5pt; color:#475569; }

    /* Separador */
    .sep { border:none; border-top:0.3mm solid #1a2744; margin:1mm 0; }

    /* Destinatario */
    .dest      { flex:1; }
    .dest-lbl  { font-size:4pt; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.8px; margin-bottom:0.3mm; }
    .fnum      { font-size:13pt; font-weight:900; color:#1a2744; line-height:1; margin-bottom:0.5mm; }
    .cli       { font-size:6.5pt; font-weight:700; color:#1a2744; margin-bottom:0.5mm; }
    .row-d     { display:flex; justify-content:space-between; align-items:baseline; margin-bottom:0.3mm; }
    .lbl       { font-size:4pt; color:#94a3b8; text-transform:uppercase; font-weight:600; flex-shrink:0; }
    .val       { font-size:5.5pt; font-weight:700; color:#1a2744; text-align:right; max-width:50mm; word-break:break-word; }
    .dir       { font-size:5.5pt; font-weight:700; color:#0f172a; line-height:1.2; margin-top:0.5mm;
                 padding:0.8mm; background:#f1f5f9; border-radius:0.8mm; }

    /* Contador caja */
    .bot { display:flex; flex-direction:column; align-items:center; }
    .cnt { display:flex; align-items:baseline; gap:0.5mm; }
    .ca  { font-size:14pt; font-weight:900; color:#1a2744; }
    .cs  { font-size:9pt; font-weight:700; color:#94a3b8; }
    .ct  { font-size:9pt; font-weight:700; color:#64748b; }
    .cl  { font-size:5pt; font-weight:700; color:#1a2744; text-transform:uppercase; letter-spacing:0.4px; margin-top:0.3mm; }
    .ts  { font-size:4pt; color:#94a3b8; margin-top:0.3mm; }
  </style></head>
