...
function printSticker() {
  ...
  for (let caja = 1; caja <= cajas; caja++) {
    ...
    pages.push(`<div class="sp"${!esUltima ? ' style="page-break-after:always;margin-bottom:4mm"' : ''}>
      ...
      <div class="col-rem">
        ...
        <div class="rem-d">Cr 53 #48-15 P7</div>
        <div class="rem-d">Medellin-Colombia</div>
        <div class="caja-box">
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0; font-family:Arial,sans-serif; }
    ...
    /* Columna izquierda: remitente ~28mm */
    .col-rem {
      width:28mm; padding:3mm 2mm;
      display:flex; flex-direction:column; align-items:center;
      background:#f8fafc; gap:1mm;
    }
    .logo    { width:18mm; height:18mm; object-fit:contain; }
    .rem-nom { font-size:6pt; font-weight:900; color:#1a2744; text-align:center; margin-top:1mm; }
    .rem-d   { font-size:4.5pt; color:#475569; text-align:center; line-height:1.3; }

    /* Caja counter en columna izquierda */
    .caja-box { margin-top:auto; text-align:center; background:#1a2744; border-radius:1.5mm; padding:1.5mm; width:100%; }
    .ca { font-size:14pt; font-weight:900; color:white; }
    .cs { font-size:9pt; font-weight:700; color:#94a3b8; }
    .ct { font-size:9pt; font-weight:700; color:#cbd5e1; }
    .cl { font-size:4.5pt; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.5px; }

    /* Divisor vertical */
    .vline { width:0.3mm; background:#1a2744; flex-shrink:0; }

    /* Columna derecha: destinatario ~72mm */
    .col-dest {
      flex:1; padding:3mm 3mm;
      display:flex; flex-direction:column; gap:0.8mm;
    }
    .dest-lbl { font-size:4.5pt; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:0.8px; }
    .fnum     { font-size:16pt; font-weight:900; color:#1a2744; line-height:1; }
    .cli      { font-size:7pt; font-weight:700; color:#1a2744; }
    .row-d    { display:flex; justify-content:space-between; align-items:baseline; }
    .lbl      { font-size:4.5pt; color:#94a3b8; text-transform:uppercase; font-weight:600; flex-shrink:0; }
    .val      { font-size:6pt; font-weight:700; color:#1a2744; text-align:right; max-width:45mm; word-break:break-word; }
    .dir      { font-size:6.5pt; font-weight:700; color:#0f172a; line-height:1.25; margin-top:1mm;
                padding:1mm; background:#f1f5f9; border-radius:1mm; }
    .ts       { font-size:4pt; color:#94a3b8; margin-top:auto; }
  </style></head>
  <body>${pages.join('')}</body></html>`;

  const win = window.open('','_blank',`width=500,height=${Math.min(cajas,4)*350}`);
